...
const SplineBackground = ({ className = '',onLoaded }) => {
  ...
  return (
   <div className={`absolute inset-0 overflow-hidden ${className}`}>
    { <img onLoad={onLoaded} src={Image} className="absolute w-full h-full object-cover inset-0 brightness-125" alt="" /> 
        // The below code is for the video animation.
        // <video
        //   src={Animation}
        //   onCanPlayThrough={onLoaded}
        //   poster={Image}
        //   className={`absolute w-full h-full object-cover inset-0 brightness-150`}
        //   autoPlay
        //   muted
        //   preload="auto"
        //   playsInline
